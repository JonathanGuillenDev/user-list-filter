...
export default {
  ...
  methods: {
    ...
    flipStatus(id){
      const toFlip = this.findUserById(id);
      this.users[toFlip].status === "Active" ? 
      this.users[toFlip].status = "Disabled" : this.users[toFlip].status = "Active";
    },
    findUserById(id){
    ...
    enableSelectedUsers(){
      this.selectedUserIDs.forEach((id) => {
        return this.users[this.findUserById(id)].status = "Active";
      });
      this.selectedUserIDs = [];
    },
    disableSelectedUsers(){
      this.selectedUserIDs.forEach((id) => {
        return this.users[this.findUserById(id)].status = "Disabled";
      });
      this.selectedUserIDs = [];
    },
    deleteSelectedUsers(){
